---
title: Det traumatiserade nervsystemet - En guide till Fight, Flight, Freeze och Fawn
description: Kroppens överlevnadssystem kan fastna i kamp-, flykt-, frys- eller fawn-respons efter trauma. Denna guide förklarar varje respons, hur de aktiveras i nervsystemet och varför de kan dominera långt efter att faran är över.
date: 2025-11-12
samling: fordjupning
references:
...
Att förstå vilken respons som dominerar är det första steget mot läkning. Ofta är det nödvändigt att först aktivera en _freeze_-respons till en mer mobiliserad respons (_fight_ eller _flight_), för att sedan varsamt slutföra den handling kroppen ville utföra (till exempel att fly eller slåss) på ett säkert och kontrollerat sätt. Detta är en grundprincip i kroppsorienterade terapiformer som Somatic Experiencing (Levine, 1997).
