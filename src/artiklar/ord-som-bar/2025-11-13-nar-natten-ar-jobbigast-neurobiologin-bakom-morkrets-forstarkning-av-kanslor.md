...
**Kortisol**, kroppens huvudsakliga stresshormon, följer en tydlig dygnsrytm. Kortisolnivåerna är naturligt **lägst** under de tidiga nattimmarna (cirka 00:00 till 03:00) och börjar sedan stiga kraftigt före uppvaknandet (_Cortisol Awakening Response_, CAR). När kortisolnivåerna är som lägst under natten minskar vår fysiologiska beredskap och vår förmåga att mobilisera försvar mot negativa känslor. Paradoxalt nog kan detta göra oss mer känsliga för inre stressorer och mardrömmar i den djupa sömnen (Clow et al., 2004).
