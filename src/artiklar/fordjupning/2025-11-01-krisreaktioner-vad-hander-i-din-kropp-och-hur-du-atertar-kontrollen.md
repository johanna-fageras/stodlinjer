...
references:
  ...
  - Kinnunen, E., & Linder, L. (u.å.). *Sjuksköterskors copingstrategier vid arbetsrelaterad stress* (Litteraturstudie). Vårdförbundet. 4
  - Livsviktiga snack. (u.å.). *Copingstrategier*. 6
  - Mielenterveystalo. (u.å.). *Krisens faser och återhämtning efter en kris*. Hämtad från [https://www.mielenterveystalo.fi/sv/trauma-kriser/krisens-faser-och-aterhamtning-efter-en-kris].
  - Region Jönköpings Län. (u.å.). *Behandlingsåtgärderna uppdelas här efter åtgärd* (Dokument om ångestbehandling). 2
  - Rudman, B. (2025). *Evidens och resultat – metod, modeller och utfall för stressprevention*. 7
  - Schoeller, M. (2022). *Polyvagalteorin*.
  - Vårdguiden 1177. (u.å.). *Avslappning för hela kroppen*. Hämtad från [https://www.1177.se/liv--halsa/stresshantering-och-somn/avslappning-for-hela-kroppen/]. 3
  - Ågren, M., & Ländell, E. (2024). *Emotionsreglering vid vardaglig ångest - En kvalitativ studie av unga vuxnas strategier* (Kandidatuppsats). Örebro universitet. 5
---
