...
2. **Kärleksvärde:** Tron att ens värde enbart är knutet till ens _bidrag_ och _förmåga att vara oberoende_. När förmågan att bidra minskar på grund av sjukdom eller kris, rasar självbilden.
...
Erkänn känslans intensitet: "Detta är en _otroligt smärtsam_ känsla som är ett resultat av min depression/ångest." Detta validerar upplevelsen utan att acceptera dess premisser. Utmana sedan de automatiska tankarna:

- **Sök bevis:** Fråga dig själv: "Vilka bevis har jag för att jag är en börda? Vilka bevis har jag för att jag _inte_ är det?" Fokusera på de små bevisen på omsorg, till exempel att någon ringde dig eller tog sig tid att lyssna.
